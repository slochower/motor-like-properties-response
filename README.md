...
The most current version of the `master` branch is built by continuous integration and [available via gh-pages](https://slochower.github.io/motor-like-properties-response/).
To see what's incoming, check the [open pull requests](https://github.com/slochower/motor-like-properties-response/pulls).

Instructions for using Manubot Rootstock for your own manuscript are still evolving.
The recommended approach is to clone this repository, as detailed [here](https://github.com/slochower/motor-like-properties-response/issues/6#issuecomment-314541837).
...
[![Build Status](https://travis-ci.org/slochower/motor-like-properties-response.svg?branch=master)](https://travis-ci.org/slochower/motor-like-properties-response/)
...
When a pull request is merged, Travis CI performs the build and writes the results to the [`gh-pages`](https://github.com/slochower/motor-like-properties-response/tree/gh-pages) and [`output`](https://github.com/slochower/motor-like-properties-response/tree/output) branches.
The `gh-pages` branch hosts the following URLs:

+ **HTML manuscript** at https://slochower.github.io/motor-like-properties-response/
+ **PDF manuscript** at https://slochower.github.io/motor-like-properties-response/manuscript.pdf
...
Please attribute by linking to https://github.com/slochower/motor-like-properties-response.
...
Please open [an issue](https://github.com/slochower/motor-like-properties-response/issues) for any question related to licensing.
